...
const QUESTIONS = [
  {
    ...
    options: [
      ...
      { text: 'Prefiro pedir ajuda a alguém que já passou por isso — não quero reinventar a roda', scores: { social: 2, pratico: 1, suporte: 1 } },
  ...
  },
  {
    ...
    options: [
      ...
      { text: 'Tenho dificuldade com coisas abstratas — preciso ver para entender', scores: { pratico: 2, bloqueio: 1, sp_frontend: 1, sp_product_design: 1 } },
